<div class="sticky bottom-0 z-50">
    <!-- Toggle Button -->
    <button id="navbar-toggle" class="w-64 py-2 rounded-2xl bg-white/20 backdrop-blur-sm text-slate-800 border border-slate-200 font-poppins text-sm flex flex-row gap-1 items-center justify-center mb-2 ml-6 shadow-lg">
    ...
    <div id="nav-content" class="transition-all duration-300 ease-in-out overflow-hidden w-screen">
        <div class="flex flex-row px-6 my-4 w-full h-1/2 gap-4">
            <!-- Navigation Bar -->
            <div class="flex flex-col justify-between items-center rounded-3xl bg-white/20 border backdrop-blur-sm border-slate-200 h-full w-64 px-2 py-2 gap-2 shadow-lg">
                <a href="{{ route('beranda') }}" class="w-full justify-center items-center">
                    <div class="cursor-pointer w-full py-2 rounded-2xl bg-slate-800 text-white font-poppins text-sm text-center">
                        Beranda
                    </div>
                </a>
                <a href="{{ route(name: 'informasi-jurusan') }}" class="w-full justify-center items-center">
                    <div class="cursor-pointer w-full py-2 rounded-2xl bg-slate-800 text-white font-poppins text-sm text-center">
                        Informasi Jurusan
                    </div>
                </a>
                <a href="{{ route('organisasi-mahasiswa') }}" class="w-full justify-center items-center">
                    <div class="cursor-pointer w-full py-2 rounded-2xl bg-slate-800 text-white font-poppins text-sm text-center">
                        Organisasi Mahasiswa
                    </div>
                </a>
                <a href="{{ route('kalender-kegiatan') }}" class="w-full justify-center items-center">
                    <div class="cursor-pointer w-full py-2 rounded-2xl bg-slate-800 text-white font-poppins text-sm text-center">
                        Kalender Kegiatan
                    </div>
                </a>
                <a href="{{ route('mata-kuliah') }}" class="w-full justify-center items-center">
                    <div class="cursor-pointer w-full py-2 rounded-2xl bg-slate-800 text-white font-poppins text-sm text-center">
                        Mata Kuliah
                    </div>
                </a>
                <a href="{{ route('alumni') }}" class="w-full justify-center items-center">
                    <div class="cursor-pointer w-full py-2 rounded-2xl bg-slate-800 text-white font-poppins text-sm text-center">
                        Alumni
                    </div>
                </a>
            ...
            <div class="flex justify-end w-full p-4">
                <div class="flex flex-col justify-start items-center w-full bg-white/20 rounded-3xl border backdrop-blur-sm border-slate-200 p-4 gap-4 shadow-lg">
